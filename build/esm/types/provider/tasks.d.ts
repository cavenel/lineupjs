...
export declare class MultiIndices {
    ...
    get joined(): IndicesArray;
}
export interface ARenderTaskOptions {
    stringTopNCount: number | readonly string[];
}
export declare class ARenderTasks {
    protected readonly valueCacheData: Map<string, readonly string[] | Float32Array<ArrayBufferLike> | Int32Array<ArrayBufferLike> | Float64Array<ArrayBufferLike> | UIntTypedArray>;
