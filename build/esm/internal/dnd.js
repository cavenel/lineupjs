 ...
 * @internal
 */
export function dragAble(node, onDragStart, onDragEnd, stopPropagation = false) {
    const id = ++idCounter;
    ...
    node.addEventListener('dragend', (e) => {
        ...
        // remove all
        const over = node.ownerDocument.getElementsByClassName(cssClass('dragover'))[0];
        if (over) {
 ...
 * @internal
 */
export function dropAble(node, mimeTypes, onDrop, onDragOver = null, stopPropagation = false, canDrop = () => true) {
