 ...
 */
class ACommonDataProvider extends ADataProvider {
     ...
     */
    removeDesc(column, ignoreBeingUsed = false) {
    ...
    fromDescRef(descRef) {
        if (typeof descRef === 'string') {
            return this.columns.find((d) => `${d.type}@${d.column}` === descRef || d.type === descRef);
        }
