...
export default class LineUpBuilder {
     ...
     */
    registerToolbarDialogAddon(id, addon) {
     ...
     * @default 18 and 2
     */
    rowHeight(rowHeight, rowPadding = 2) {
     ...
     * @default 40 and 5
     */
    groupRowHeight(groupHeight, groupPadding = 5) {
